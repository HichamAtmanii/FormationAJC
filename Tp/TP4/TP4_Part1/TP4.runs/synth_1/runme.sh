...
HD_PWD='C:/Users/hicha/OneDrive/Bureau/TP4/TP4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TP4_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TP4_FSM.tcl
